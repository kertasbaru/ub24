...
# Repositori
REPO="https://raw.githubusercontent.com/kertasbaru/ub24/main/"
...
function main() {
    ...
    apt install -y curl wondershaper lsb-release jq wget socat unzip 
...
username=$(curl https://raw.githubusercontent.com/kertasbaru/vps_access/main/ip | grep $IP_VPS | awk '{print $2}')
echo "$username" >/usr/bin/user

# Save Expired Detail in github to /usr/bin/e
expx=$(curl https://raw.githubusercontent.com/kertasbaru/vps_access/main/ip | grep $IP_VPS | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/kertasbaru/vps_access/main/ip | grep $IP_VPS | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/kertasbaru/vps_access/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/kertasbaru/vps_access/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/WuzzSTORE"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6287760204418"}]]}'
...
hostcf=$(cat /root/domain)
sed -i "s/xxx/${hostcf}/g" /etc/haproxy/haproxy.cfg
...
wget raw.githubusercontent.com/kertasbaru/ub24/main/files/limit-quota.sh && chmod +x limit-quota.sh && ./limit-quota.sh
print_install "Memasang Service Locked xray"
wget raw.githubusercontent.com/kertasbaru/ub24/main/lock-service.sh && chmod +x lock-service.sh && ./lock-service.sh
cd
